...
export function typographyValueStyle(role: TypographyRole, values: TypographyValues, weightOverride?: number): CSSProperties {
  const value = values[role];
  return { fontFamily: 'var(--ui-font-family)', fontSize: `${value.size}px`, lineHeight: `${value.lineHeight}px`, fontWeight: weightOverride ?? value.weight };
}
